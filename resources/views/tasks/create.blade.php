...
<head>
  ...
  background: #450a0a;
        ...
        .breadcrumb a { color: #f87171; text-decoration: none; }
        .breadcrumb a:hover { color: white; }
        .sep { color: #7f1d1d; }

        .page { max-width: 580px; margin: 48px auto; padding: 0 24px; }

        .page-title { font-size: 20px; font-weight: 700; color: #7f1d1d; margin-bottom: 4px; }
        .page-sub   { font-size: 13px; color: #9b2c2c; margin-bottom: 28px; }
    ...
    padding: 11px 14px;
        ...
        .divider { height: 1px; background: #fee2e2; margin: 24px 0; }
